...
val GBTABLE = arrayOf(
    ...
    "Valcambi Minted Bar",
    "Valcambi Cast Bar",
    "Credit Suisse Minted Bar",
    "RMR Minted Bar",
    "RMR Cast Bar",
    "RMR Britannia Minted Bar",
    "Pert Mint Bar Minited",
    "Pert Mint Cast Bar",
    "Austrian Mint Minted Bar",
    "Austrian Mint Cast Bar",
    "Geiger Edelmetalle Cast Bar",
    "Geiger Edelmetalle Minted Bar",
    "Sunshine Mint Bar",
    "LS-Nikko Minted Bar",
    "LS-Nikko Cast Bar",
    "Asahi minted Bar",
    ...
    "KOMSCO Orodt Bar",
    "Scottsdale Cast Bar",
    "Scottsdale Minted Bar",
    "Scottsdale Marquee Bar",
    "Scottsdale Lunar Bar"
)
